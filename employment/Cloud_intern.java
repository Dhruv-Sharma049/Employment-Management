...
public class Cloud_intern implements Intern {
    // Cloud Intern attributes
    ...
    private int pin;
    private String domain = "cloud";
    private Scanner sc = new Scanner(System.in);

    /**
     * Constructor to initialize a Cloud Intern object.
     * @param f_name First name of the intern
     * @param l_name Last name of the intern
     * @param email Email address of the intern
     * @param emp_id Employee ID
     */
    public Cloud_intern(String f_name, String l_name, String email, int emp_id) {
        this.email = email;
        this.emp_id = emp_id;
        this.f_name = f_name;
        this.l_name = l_name;
